...
export const fr: Dict = {
  ...
  params: {
    ...
    selManual: 'Manuel',
    selCreate: 'Créer la sélection',
    selAdjust: 'Ajuster la sélection',
    selManualStart: 'Sélectionner à la main',
    magicDetect: "Détecter l'objet",
    methodStep: 'Méthode de détection',
    methodInvite: 'Essaie Standard ou Contours pour le meilleur détourage.',
    selNext: 'Continuer',
    toolPoints: 'Points',
    toolStraighten: 'Redresser',
    toolHint: 'Choisis un outil pour retoucher la sélection.',
  ...
  landing: {
    ...
    tokenBody:
      'Un disque de 76,2 mm à imprimer en 3D. Il donne l’échelle à Snapfinity : sans lui, pas de calibrage. Imprime-le à 100%, puis mesure son diamètre et saisis-le dans l’app.',
