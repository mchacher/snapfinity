...
| 012 | [browser-vision](../specs/012-browser-vision/) | In review | Vision in the browser: photo upload → token + u2netp mask, **live overlay** + auto-size. onnxruntime-web, shared `cleanMask`. Iteration 8 (part 1). |
