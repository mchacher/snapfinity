...
| 025 | [undo-redo](../specs/025-undo-redo/) | In review | **Multi-step undo/redo** over the params **and** the brush edits (⌘Z / ⌘⇧Z + header buttons). Coalesces slider drags / brush strokes into one step; pure history stack unit-tested. Iteration 18. |
