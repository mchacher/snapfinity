...
| 003 | [cad-replicad-spike](../specs/003-cad-replicad-spike/) | In review | Parametric Gridfinity bin in replicad (headless tests, STL export); foot modelled in replicad (Python bake dropped). Iteration 2. |
